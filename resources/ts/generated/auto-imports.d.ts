...
declare global {
  ...
  const inertia: typeof import('@inertiajs/svelte')['inertia']
  ...
  const route: typeof import('../helpers/ziggy')['route']
  const router: typeof import('@inertiajs/svelte')['router']
  ...
  const useForm: typeof import('@inertiajs/svelte')['useForm']
  const useInput: typeof import('../helpers/InputHelpers')['useInput']
